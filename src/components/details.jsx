...
function Details(){
    ...
    return (
        ...
        <input className="textbox" name ="time" type="date" placeholder="Enter Date and Time"  />
        <input  className="textbox" name ="contact" type="tel" placeholder="Enter Phone Number"  />
